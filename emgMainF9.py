...
mlp = load(open("/home/pi/NN2/modelop3-I2.pkl", 'rb'))
# Cargar escalador de características
scaler = load(open("/home/pi/NN2/escaladorp3-I2.pkl", 'rb'))
...
if __name__ == '__main__':
    ...
    GPIO.add_event_detect(pin_inicio, GPIO.RISING, callback = iniciarSistema, bouncetime = 500)
    ...
    def proc_emg(emg, moving, times=[]):
        ...
        global clasif_mod2, startTime, iniciar_sis
...
#                 print(media_auxT)
                ...
                print("Mov: ", movPred)
                print("MovF: ", int(gesto[0]))

                
                enviarMov(int(gesto[0]))
